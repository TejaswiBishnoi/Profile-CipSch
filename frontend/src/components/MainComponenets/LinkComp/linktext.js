    ...
    return(
        <Box width={'100%'} sx={{borderRadius: '8px', overflow: 'hidden', backgroundColor: props.theme.mainTextBack}}>
            <Stack direction={'row'} alignItems={'center'}>
                ...
                <div className="AboutMainField" style={{width: '100%', backgroundColor: props.theme.mainTextBack}}>
                    <TextField placeholder="Add something about you." sx={{width: '100%', color:props.theme.mainTextColor}} value={props.about} onChange={(e)=>{props.setAbout(e.target.value)}} variant="outlined" inputProps={{readOnly: props.readonly?true:false}}/>
                </div>
            </Stack>
        </Box>
    );
